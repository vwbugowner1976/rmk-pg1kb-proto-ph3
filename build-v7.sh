...
cargo fetch
chmod +x scripts/patch_rmk_fast_host_adv.sh \
         scripts/patch_rmk_split_trackball_latency.sh \
         scripts/patch_rmk_rynk_custom_hook.sh
./scripts/patch_rmk_fast_host_adv.sh 50
./scripts/patch_rmk_split_trackball_latency.sh 0
./scripts/patch_rmk_rynk_custom_hook.sh
